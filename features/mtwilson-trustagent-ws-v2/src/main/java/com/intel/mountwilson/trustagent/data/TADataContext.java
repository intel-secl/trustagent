...
public class TADataContext {
    ...
    private TpmQuote tpmQuote = null;
    ...
    public void setSelectedPcrBanks(List<String> selectedPcrBanks) {
    ...
    public TpmQuote getTpmQuote() {
        return tpmQuote;
    }

    public void setTpmQuote(TpmQuote tpmQuote) {
